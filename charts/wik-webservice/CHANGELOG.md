...
* **wik-webservice:** does not check httproute.tls condition when httproute.enabled is false

### Chores

* **wik-webservice:** release v0.7.4 [skip ci]
...
* **wik-webservice:** Listener instead of ListenerSet

### Chores

* **wik-webservice:** release v0.7.2 [skip ci]


## [wik-webservice-v0.7.2](https://github.com/wikodit/charts/compare/wik-webservice-v0.7.1...wik-webservice-v0.7.2) - 2026-05-29

### Bug Fixes

* **wik-webservice:** typo that unit test didn't cactch..

### Chores

* **wik-webservice:** release v0.7.1 [skip ci]
...
* **wik-webservice:** release v0.6.1 [skip ci]
...
* **wik-webservice:** improve support for ListenerSet
